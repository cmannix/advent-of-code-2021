...
let day2Part1Result =
 ...
 |> Seq.fold Day2.updatePositionPart1 { HorizontalPosition = 0; Depth = 0; Aim = 0 }
 |> fun finalPosition -> finalPosition.Depth * finalPosition.HorizontalPosition
printfn $"Day 2 (Part 1): Product of final horizontal and vertical positions = %i{day2Part1Result}"

let day2Part2Result =
 File.ReadLines("Day2/input.txt")
 |> Seq.map Day2.parseCommand
 |> Seq.fold Day2.updatePositionPart2 { HorizontalPosition = 0; Depth = 0; Aim = 0 }
 |> fun finalPosition -> finalPosition.Depth * finalPosition.HorizontalPosition
